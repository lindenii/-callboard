...
(function($){
    ...
    $.fn.makemediadescription = function(options){
        ...
        container.append(
            '<div contenteditable="true" class="article-description">' +
            insidedescription +
            '</div>');
        ...
        var contentHolder = container.find('.article-description');
        contentHolder.attr('id', 'article-descr-' + id);
...
//============================ KEYPRESS ===============================//
        ...
        container.on('mousedown', contentHolder, function(){
                ...
                if (counter == length){
                    ...
                    if (cclass != ''){
                        ...
                        if (type == 'span'){
                            ...
                            // BUG - откомментируй, и познаешь его силу ;)
